y<p align="center"><img width="100" src="https://vankizmann.github.io/nano-ui/nano.png" alt="nano.ui"></p>

<h2 align="center">nano.ui Version 0.1.0</h2>

### Done and reworked
- [Draggable](./docs/draggable/index.html)
- [Scrollbar](./docs/scrollbar/index.html)
- [Virtualscroller](./docs/virtualscroller/index.html)
...
- [Loader](./docs/loader/index.html)
- [Popover](./docs/popover/index.html)
- [Modal](./docs/modal/index.html)
- [Confirm](./docs/confirm/index.html)
- [Table](./docs/table/index.html)
- [Paginator](./docs/paginator/index.html)
