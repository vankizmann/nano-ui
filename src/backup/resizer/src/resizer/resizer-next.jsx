import { Run, Arr, Obj, Dom, Mix, Str, Locale, Signal, Num } from "@kizmann/pico-js";
...
export default {
    ...
    mounted()
    {
        ...
        Signal.bind('NScrollbar:paused', (...args) => {
            this.updateRemoteWidth(...args)
        }, this._.uid);

        Signal.bind('NResizer:move', (...args) => {
    ...
    unmounted()
    {
        ...
        Signal.unbind('NScrollbar:paused',
            this._.uid);

        Signal.unbind('NResizer:move',
            this._.uid);
    },
    ...
    methods: {
        ...
        onLeftMousedown(event)
        {
            ...
            if ( this.group.length ) {
                Signal.fire('NResizer:move', this.group);
            }
        ...
        onLeftMouseup(event)
        {
            ...
            if ( this.group.length ) {
                Signal.fire('NResizer:moved', this.group);
            }
