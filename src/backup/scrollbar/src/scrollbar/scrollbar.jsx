import { Run, Arr, Obj, Dom, Mix, Str, Signal, Hash } from "@kizmann/pico-js";
...
export default {
    ...
    methods: {
        ...
        onScroll(e)
        {
            Signal.fire('NScrollbar:scroll', e);
        ...
        onVbarMousemove(event)
        {
            ...
            console.log(this.scrollTop, this.heightRatio);
