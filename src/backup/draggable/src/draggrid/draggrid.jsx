import { Hash, Num, Arr, Obj, Dom, Mix, Signal, Locale } from "@kizmann/pico-js";
...
export default {
    ...
    methods: {
        ...
        setCurrent(node)
        {
            ...
            Signal.fire('NDraggrid:syncCurrent', node.item, this.uid);
        },
        ...
        setRawCurrent(index)
        {
            ...
            Signal.fire('NDraggrid:syncCurrent', item, this.uid);
        },
