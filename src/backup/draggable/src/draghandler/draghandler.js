import { Run, Num, Arr, Obj, Mix, Dom, Signal, Locale, Hash } from "@kizmann/pico-js";
...
class NDraghandler
{
    ...
    bindRoot(frame = null)
    {
        ...
        Signal.bind('NDrag:start', this.bindDragstart.bind(this),
            this.rootNode.uid);

        Signal.bind('NDrag:end', this.bindDragend.bind(this),
            this.rootNode.uid);

        Signal.bind('NDrag:drop', this.bindDragdrop.bind(this),
            this.rootNode.uid);
    }
    ...
    unbindRoot()
    {
        ...
        Signal.unbind('NDrag:start', this.rootNode.uid);
        Signal.unbind('NDrag:end', this.rootNode.uid);
        Signal.unbind('NDrag:drop', this.rootNode.uid);
    }
    ...
    onDragstartNode(event, node)
    {
        ...
        Signal.fire('NDrag:start', this.rootNode.group,
